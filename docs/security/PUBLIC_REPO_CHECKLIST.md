***REMOVED*** Public Repo Safety Checklist

Use this checklist **before** switching the repository visibility to public.

***REMOVED******REMOVED*** Working tree (current files)
...
***REMOVED******REMOVED*** Git history (past commits)
