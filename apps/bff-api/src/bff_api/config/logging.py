"""Centralized logging configuration for the BFF API.
...
def configure_logging(
    ...
    ***REMOVED*** Add file handler if log_dir is provided
    if log_dir:
        ...
        log_file = log_dir / f"bff_api_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def get_logger(name: str) -> logging.Logger:
    ...
    """
    return logging.getLogger(f"bff_api.{name}")
