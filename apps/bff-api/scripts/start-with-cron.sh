...
# BFF API Startup Script with Smart Cache Warming
#
# Production Mode: Warms ALL available movies (no limits)
# Development Mode: Uses debug limits for faster testing
#
# Environment Variables:
# - ENVIRONMENT: "production" or "development"
# - ENABLE_CACHE_WARMING: "true" or "false" (default: true)
# - TIER1_DEV_LIMIT: Max movies for Tier 1 in dev (default: 50)
# - TIER2_DEV_LIMIT: Max movies for Tier 2 in dev (default: 200)
# - TIER3_DEV_LIMIT: Max movies for Tier 3 in dev (default: 500)

echo "🚀 Starting BFF API with cache warming..."

# Configuration variables for warming strategy
# Production: warm ALL movies (no limits), Development: use limits for faster testing
...
# Development Cache Warming Schedule - Limited for faster testing
# Tier 1: New releases + trending (every 4 hours) - DEBUG LIMITS
...
# Tier 2: Popular movies (twice daily) - DEBUG LIMITS
...
# Tier 3: Full catalog (weekly, smaller sample) - DEBUG LIMITS
...
# Switch to app user and start the API
