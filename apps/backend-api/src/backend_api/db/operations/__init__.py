...
from backend_api.db.operations.genre import (
    create_genre,
    delete_genre,
    get_genre_by_id,
    get_genre_by_name,
...
from backend_api.db.operations.movie import (
    create_movie,
    delete_movie,
    get_movie_by_id,
...
from backend_api.db.operations.trailer import create_trailer
from backend_api.db.operations.user import (
    authenticate_user,
    create_user,
    delete_user,
    get_user_by_email,
...
from backend_api.db.operations.user_interaction import (
