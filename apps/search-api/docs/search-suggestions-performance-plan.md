## Search suggestions performance: findings and plan
...
### Phase 1.5 — Runtime hydration optimization (low-risk, high impact)
...
### Phase 2 — Better indexing to avoid SCAN at runtime
...
### Phase 3 — Redis Stack RediSearch (optional, infra-dependent)
