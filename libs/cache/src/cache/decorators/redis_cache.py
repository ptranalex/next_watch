...
def redis_cache(
    ...
    def decorator(func: F) -> F:
        # Get function signature for key building
        ...
        if asyncio.iscoroutinefunction(func):
            ...
            async def async_wrapper(*args: Any, **kwargs: Any) -> Any:
                ...
                try:
                    ...
                    # Cache read failed, continue to function execution
                    pass
                ...
                try:
                    ...
                    # Cache write failed, but return result anyway
                    pass
            ...
            def sync_wrapper(*args: Any, **kwargs: Any) -> Any:
                ...
                # to use a sync Redis client or run in thread pool
